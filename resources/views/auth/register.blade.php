<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <!-- Phone -->
        <div class="mt-4">
            <x-input-label for="phone" :value="__('Phone (Philippines) ')" />
            <x-text-input id="phone" class="block mt-1 w-full" type="text" name="phone" :value="old('phone')" required placeholder="09XXXXXXXXX" autocomplete="phone" />
